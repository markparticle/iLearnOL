...
class Course(models.Model):
    ...
    degree = models.CharField(choices=(('initial','初级'),(' medium','中级'),('advanced','高级')),max_length=10,verbose_name='课程等级')
    ...
    big_image = models.ImageField(upload_to='courses/%Y/%m', verbose_name='详情大图', max_length=100, blank=True, null=True)
    click_nums = models.IntegerField(default=0,verbose_name='点击数')
    category = models.CharField(max_length=20,verbose_name='课程类别',default='0')
    course_know = models.CharField(max_length=300, verbose_name='课程须知',default='')
    course_new = models.CharField(max_length=50, verbose_name='课程通知',default='')
...
class Video(models.Model):
    ...
    learn_times = models.IntegerField(default=0,verbose_name='视频时间(分钟数)',)
    add_time = models.DateTimeField(default=datetime.now, verbose_name='添加时间')
