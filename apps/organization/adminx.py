...
class CourseOrgAdmin(object):
    list_display = ['name', 'desc','add_time','click_nums','fav_nums','address','city','category','students','course_nums']
    search_fields =['name', 'desc','click_nums','fav_nums','address','city','category','students','course_nums']
    list_filter =['name', 'desc','add_time','click_nums','fav_nums','address','city','category','students','course_nums']
