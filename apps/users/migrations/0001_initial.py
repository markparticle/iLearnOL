    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gender', models.CharField(choices=[('male', '男'), ('femail', '女')], default='', max_length=5, verbose_name='性别')),
                ...
                ('image', models.ImageField(default='image/default', upload_to='image/%Y/%m', verbose_name='hun用户头像')),
