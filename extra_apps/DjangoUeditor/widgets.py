    ...
    def recalc_path(self, model_inst):
        ...
        try:
            ...
            if uSettings['imagePathFormat']!="":
                uSettings['scrawlPathFormat']=uSettings['scrawlPathFormat'] if self._upload_settings.get("scrawlPathFormat", None) else uSettings['imagePathFormat']
                uSettings['videoPathFormat']=uSettings['videoPathFormat'] if self._upload_settings.get("videoPathFormat", None) else uSettings['imagePathFormat']
                uSettings['snapscreenPathFormat']=uSettings['snapscreenPathFormat'] if self._upload_settings.get("snapscreenPathFormat", None) else uSettings['imagePathFormat']
                uSettings['catcherPathFormat']=uSettings['catcherPathFormat'] if self._upload_settings.get("catcherPathFormat", None) else uSettings['imagePathFormat']
                uSettings['imageManagerListPath']=uSettings['imageManagerListPath'] if self._upload_settings.get("imageManagerListPath", None) else uSettings['imagePathFormat']
            if uSettings['filePathFormat']!="":
                uSettings['fileManagerListPath']=uSettings['fileManagerListPath'] if self._upload_settings.get("fileManagerListPath", None) else uSettings['filePathFormat']
        except:
            pass
