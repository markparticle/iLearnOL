...
def UpdateUserSettings():
    ...
    if UserSettings.get("config", None):UEditorSettings.update(UserSettings["config"])
    if UserSettings.get("upload", None):UEditorUploadSettings.update(UserSettings["upload"])
